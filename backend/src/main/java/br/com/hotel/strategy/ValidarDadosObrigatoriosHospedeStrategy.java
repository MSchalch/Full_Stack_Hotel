...
public class ValidarDadosObrigatoriosHospedeStrategy implements IStrategy {
    ...
    public String processar(EntidadeDominio entidade) {
        if (entidade instanceof Hospede hospede) {
            ...
            if (hospede.getTelefone() == null || hospede.getTelefone().getDescricao() == null || hospede.getTelefone().getDescricao().trim().isEmpty()) {
                return "Telefone é obrigatório.";
            }
            if (hospede.getEmail() == null || hospede.getEmail().getDescricao() == null || hospede.getEmail().getDescricao().trim().isEmpty()) {
            ...
            if (end.getLogradouro() == null || end.getLogradouro().trim().isEmpty() ||
                ...
                end.getCidade() == null || end.getCidade().getEstado() == null) {
